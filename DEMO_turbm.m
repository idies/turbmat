...
% 2017: Modified by Zhao Wu and Rohit Ravoori, adding getInvariant and
% isotropic4096 comments
...
threshold_array =  getThreshold (authkey, dataset, threshold_field, time, 0, FD4NoInt, x_start, y_start, z_start, x_end, y_end, z_end);
