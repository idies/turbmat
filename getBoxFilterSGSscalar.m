...
function result = getBoxFilterSGSscalar(authToken, dataset, field, time, ...
...
%   
%     Output:
%       GetBoxFilterSGSscalarResult = (float array N)
%
...
resultStruct =  GetBoxFilterSGSscalar (obj, authToken, dataset, field, time, ...
		filterwidth, points);


result = resultStruct.GetBoxFilterSGSscalarResult.float;
