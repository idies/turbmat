...
function result = getVectorPotentialField(authToken, dataset, time, ...
		                           spatialInterpolation, temporalInterpolation, ...
                                   npoints, points)
%
%     Retrieve vector potential field for specified 'time' and 'points'
%   
%     Input:
%       authToken = (string)
%       dataset = (string)
...
%   
%     Output:
%       GetVectorPotentialResult = (float array 3xN)
%
...
resultStruct =  GetVectorPotential (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);


result = getVector(resultStruct.GetVectorPotentialResult.Vector3);
