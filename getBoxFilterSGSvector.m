...
function result = getBoxFilterSGSvector(authToken, dataset, field, time, ...
...
%   
%     Output:
%       GetBoxFilterSGSvectorResult = (float array 3xN)
%
...
resultStruct =  GetBoxFilterSGSvector (obj, authToken, dataset, field, time, ...
		filterwidth, points);


result = getVector(resultStruct.GetBoxFilterSGSvectorResult.Vector3);
