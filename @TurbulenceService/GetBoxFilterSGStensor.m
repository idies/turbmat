...
function GetBoxFilterSGStensorResult = GetBoxFilterSGStensor(obj,authToken,dataset,field,time,filterwidth,points)
%GetBoxFilterSGStensor(obj,authToken,dataset,field,time,filterwidth,points)
%
%   SGSBoxFilter
%   
%     Input:
...
%   
%     Output:
%       GetBoxFilterSGStensorResult = (ArrayOfSGSTensor)
...
response = callSoapService( ...
    ...
    soapMessage);
GetBoxFilterSGStensorResult = parseSoapResponse(response);

% Fault message handling
if isfield(GetBoxFilterSGStensorResult, 'faultstring')
    error('faultcode: %s\nfaultstring: %s\n', ...
        GetBoxFilterSGStensorResult.faultcode, ...
        GetBoxFilterSGStensorResult.faultstring);
end
