...
function GetDensityHessianResult = GetDensityHessian(obj,authToken,dataset,time,spatialInterpolation,temporalInterpolation,points)
%GetDensityHessian(obj,authToken,dataset,time,spatialInterpolation,temporalInterpolation,points)
%
...
%   
%     Output:
%       GetDensityHessianResult = (ArrayOfPressureHessian)
...
response = callSoapService( ...
    ...
    soapMessage);
GetDensityHessianResult = parseSoapResponse(response);

% Fault message handling
if isfield(GetDensityHessianResult, 'faultstring')
    error('faultcode: %s\nfaultstring: %s\n', ...
        GetDensityHessianResult.faultcode, ...
        GetDensityHessianResult.faultstring);
end