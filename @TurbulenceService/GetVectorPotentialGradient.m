...
function GetVectorPotentialGradientResult = GetVectorPotentialGradient(obj,authToken,dataset,time,spatialInterpolation,temporalInterpolation,points)
%GetVectorPotentialGradient(obj,authToken,dataset,time,spatialInterpolation,temporalInterpolation,points)
%
...
%   
%     Output:
%       GetVectorPotentialGradientResult = (ArrayOfVelocityGradient)
...
response = callSoapService( ...
    ...
    soapMessage);
GetVectorPotentialGradientResult = parseSoapResponse(response);

% Fault message handling
if isfield(GetVectorPotentialGradientResult, 'faultstring')
    error('faultcode: %s\nfaultstring: %s\n', ...
        GetVectorPotentialGradientResult.faultcode, ...
        GetVectorPotentialGradientResult.faultstring);
end
