...
function GetBoxFilterSGSsymtensorResult = GetBoxFilterSGSsymtensor(obj,authToken,dataset,field,time,filterwidth,points)
%GetBoxFilterSGSsymtensor(obj,authToken,dataset,field,time,filterwidth,points)
%
%   SGSBoxFilter
%   
%     Input:
...
%   
%     Output:
%       GetBoxFilterSGSsymtensorResult = (ArrayOfSGSTensor)
...
response = callSoapService( ...
    ...
    soapMessage);
GetBoxFilterSGSsymtensorResult = parseSoapResponse(response);

% Fault message handling
if isfield(GetBoxFilterSGSsymtensorResult, 'faultstring')
    error('faultcode: %s\nfaultstring: %s\n', ...
        GetBoxFilterSGSsymtensorResult.faultcode, ...
        GetBoxFilterSGSsymtensorResult.faultstring);
end
