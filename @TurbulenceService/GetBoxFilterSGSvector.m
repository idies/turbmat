...
function GetBoxFilterSGSvectorResult = GetBoxFilterSGSvector(obj,authToken,dataset,field,time,filterwidth,points)
%GetBoxFilterSGSvector(obj,authToken,dataset,field,time,filterwidth,points)
%
%   SGSBoxFilter
%   
%     Input:
...
%   
%     Output:
%       GetBoxFilterSGSvectorResult = (ArrayOfSGSTensor)
...
response = callSoapService( ...
    ...
    soapMessage);
GetBoxFilterSGSvectorResult = parseSoapResponse(response);

% Fault message handling
if isfield(GetBoxFilterSGSvectorResult, 'faultstring')
    error('faultcode: %s\nfaultstring: %s\n', ...
        GetBoxFilterSGSvectorResult.faultcode, ...
        GetBoxFilterSGSvectorResult.faultstring);
end
