...
function GetBoxFilterSGSscalarResult = GetBoxFilterSGSscalar(obj,authToken,dataset,field,time,filterwidth,points)
%GetBoxFilterSGSscalar(obj,authToken,dataset,field,time,filterwidth,points)
%
%   SGSBoxFilter
%   
%     Input:
...
%   
%     Output:
%       GetBoxFilterSGSscalarResult = (ArrayOfSGSTensor)
...
response = callSoapService( ...
    ...
    soapMessage);
GetBoxFilterSGSscalarResult = parseSoapResponse(response);

% Fault message handling
if isfield(GetBoxFilterSGSscalarResult, 'faultstring')
    error('faultcode: %s\nfaultstring: %s\n', ...
        GetBoxFilterSGSscalarResult.faultcode, ...
        GetBoxFilterSGSscalarResult.faultstring);
end
