...
function result = getVectorPotentialGradient(authToken, dataset, time, ...
                                           spatialInterpolation, temporalInterpolation, ...
                                           npoints, points)			     
%
%     Retrieve vector potential gradient for specified 'time' and 'points'
%   
%     Input:
%       authToken = (string)
%       dataset = (string)
...
resultStruct =  GetVectorPotentialGradient (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);

result = getVector(resultStruct.GetVectorPotentialGradientResult.VelocityGradient);
