...
function result = getDensity(authToken, dataset, time, ...
                              spatialInterpolation, temporalInterpolation, ...
                              npoints, points)
%
%     Retrieve density for specified 'time' and 'points'
%   
%     Input:
%       authToken = (string)
%       dataset = (string)
...
resultStruct =  GetDensity (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);

result = getVector(resultStruct.GetDensityResult.Pressure);
