...
function result = getBoxFilterGradient(authToken, dataset, field, time, ...
                              filterwidth, spacing, npoints, points)
%
%     Retrieve box filtered velocity gradient tensor for specified 'time' and 'points'
%   
%     Input:
%       authToken = (string)
%       dataset = (string)
...
resultStruct =  GetBoxFilterGradient (obj, authToken, dataset, field, time, ...
		filterwidth, spacing, points);


result = getVector(resultStruct.GetBoxFilterGradientResult.VelocityGradient);
