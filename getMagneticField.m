...
function result = getMagneticField(authToken, dataset, time, ...
		                           spatialInterpolation, temporalInterpolation, ...
                                   npoints, points)
%
%     Retrieve magnetic field for specified 'time' and 'points'
%   
%     Input:
%       authToken = (string)
%       dataset = (string)
...
%   
%     Output:
%       GetMagneticFieldResult = (float array 3xN)
%
...
resultStruct =  GetMagneticField (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);


result = getVector(resultStruct.GetMagneticFieldResult.Vector3);
