...
function result = getBoxFilterSGStensor(authToken, dataset, field, time, ...
...
%   
%     Output:
%       GetBoxFilterSGStensorResult = (float array 9xN)
%
...
resultStruct =  GetBoxFilterSGStensor (obj, authToken, dataset, field, time, ...
		filterwidth, points);


result = getVector(resultStruct.GetBoxFilterSGStensorResult.VelocityGradient);
