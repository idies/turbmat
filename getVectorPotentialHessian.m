...
function result = getVectorPotentialHessian(authToken, dataset, time, ...
                                          spatialInterpolation, temporalInterpolation, ...
                                          npoints, points)
%
%     Retrieve vector potential hessian for specified 'time' and 'points'
%   
%     Input:
%       authToken = (string)
%       dataset = (string)
...
resultStruct =  GetVectorPotentialHessian (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);

result = getVector(resultStruct.GetVectorPotentialHessianResult.VelocityHessian);
