...
function result = getBoxFilter(authToken, dataset, field, time, ...
                              filterwidth, npoints, points)
%
%     Retrieve box filtered velocity for specified 'time' and 'points'
%   
%     Input:
%       authToken = (string)
%       dataset = (string)
...
%   
%     Output:
%       GetBoxFilterResult = (float array 3xN)
%
...
resultStruct =  GetBoxFilter (obj, authToken, dataset, field, time, ...
		filterwidth, points);


result = getVector(resultStruct.GetBoxFilterResult.Vector3);
