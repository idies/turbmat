...
function result = getDensityHessian(authToken, dataset, time, spatialInterpolation, ...
                                     temporalInterpolation, npoints, points)			     
%
%     Retrieve Density hessian for specified 'time' and 'points'
%   
%     Input:
%       authToken = (string)
%       dataset = (string)
...
resultStruct =  GetDensityHessian (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);
   
result = getVector(resultStruct.GetDensityHessianResult.PressureHessian);
