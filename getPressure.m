...
function result = getPressure(authToken, dataset, time, ...
...
resultStruct =  GetPressure (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);

result = getVector(resultStruct.GetPressureResult.Pressure);
