...
function result = getVectorPotentialLaplacian(authToken, dataset, time, ...
                                            spatialInterpolation, temporalInterpolation, ...
                                            npoints, points)
%
%     Retrieve vector potential laplacian for specified 'time' and 'points'
%   
%     Input:
%       authToken = (string)
%       dataset = (string)
...
resultStruct =  GetVectorPotentialLaplacian (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);
    
result = getVector(resultStruct.GetVectorPotentialLaplacianResult.Vector3);
